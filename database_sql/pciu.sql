...
-- Schema PCIU
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `PCIU` ;

-- -----------------------------------------------------
-- Schema PCIU
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `PCIU` DEFAULT CHARACTER SET utf8 ;
USE `PCIU` ;

-- -----------------------------------------------------
-- Table `PCIU`.`Usuario`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `PCIU`.`Usuario` ;
...
-- Table `PCIU`.`Curso`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `PCIU`.`Curso` ;
...
-- Table `PCIU`.`Turma`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `PCIU`.`Turma` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `PCIU`.`Comunicado` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `PCIU`.`Comentario` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `PCIU`.`Turma_Usuario` ;

CREATE TABLE IF NOT EXISTS `PCIU`.`Turma_Usuario` (
  `turma_id` INT NOT NULL,
  `curso_id` INT NOT NULL,
  `matricula_id` INT NOT NULL,
  INDEX `fk_Turma_has_Usuário_Usuário1_idx` (`matricula_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `PCIU`.`Comentario_Usuario` ;

CREATE TABLE IF NOT EXISTS `PCIU`.`Comentario_Usuario` (
  `comentario_id` INT NOT NULL,
  `comunicado_id` INT NOT NULL,
  `matricula_id` INT NOT NULL,
  INDEX `fk_Comentário_has_Usuário_Usuário1_idx` (`matricula_id` ASC) VISIBLE,
  INDEX `fk_Comentário_has_Usuário_Comentário1_idx` (`comentario_id` ASC, `comunicado_id` ASC) VISIBLE,
  PRIMARY KEY (`comentario_id`, `comunicado_id`, `matricula_id`),
  CONSTRAINT `fk_Comentário_has_Usuário_Comentário1`
    FOREIGN KEY (`comentario_id` , `comunicado_id`)
    REFERENCES `PCIU`.`Comentario` (`id` , `comunicado_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
